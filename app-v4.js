...
const FITLYNE_API_URL = "https://script.google.com/macros/s/AKfycbwXwsrLMquUFRef2rM865wKidEn7EXbiNS-kymsI9sCdb8ghhBgOPldGK7uXSN_YLA_JQ/exec";
...
async function api(action, payload={}, auth=true){
  ...
  const res = await fetch(FITLYNE_API_URL, {
    method: "POST",
